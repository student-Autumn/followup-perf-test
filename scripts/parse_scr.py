...
files = [
    r'C:\ceshi\练习3\筛查人员分页1万 50-400并发.html',
    r'C:\ceshi\练习3\筛查人员分页查询 2万 50并发.html',
    r'C:\ceshi\练习3\筛查人员分页查询 4万 50并发.html',
    r'C:\ceshi\练习3\筛查人员查询 7.8万条数据.html',
]
...
for path in files:
    ...
    print(f"user_classes: {list(total.keys())}")
    for cls, info in total.items():
        t = info.get('tasks', {})
        print(f"  tasks: {json.dumps(t, ensure_ascii=False)[:400]}")
